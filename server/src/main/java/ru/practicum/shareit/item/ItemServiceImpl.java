...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public ItemDto getItemById(Long id, Map<String, String> headers) {
    ...
    @Override
    public ItemDto create(ItemDto itemDto, Map<String, String> headers) {
        Long ownerId = HeaderSerialization.getUserId(headers);
        checker.isExistUser(ownerId);
        return mapper.toItemDto(repository.save(mapper.toItem(itemDto, ownerId)));
    }

    @Override
    public List<ItemDto> getItemsByOwner(Map<String, String> headers, Integer from, Integer size) {
        Long ownerId = HeaderSerialization.getUserId(headers);
        checker.isExistUser(ownerId);
    ...
    @Override
    public void delete(Long itemId, Map<String, String> headers) {
        Long ownerId = HeaderSerialization.getUserId(headers);
    ...
    @Override
    public ItemDto update(ItemDto itemDto, Map<String, String> headers, Long itemId) {
        Long ownerId = HeaderSerialization.getUserId(headers);
        checker.isExistUser(ownerId);
        Item item = repository.findById(itemId)
                .orElseThrow(() -> new ItemNotFoundException("Вещь с ID=" + itemId + " не найдена!"));
    ...
    @Override
    public CommentDto createComment(CommentDto commentDto, Long itemId, Map<String, String> headers) {
        Long userId = HeaderSerialization.getUserId(headers);
